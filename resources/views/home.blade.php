...
<section id="reserva" style="">
	<div>
	    <div class="about_our_company" style="margin-bottom: 20px;">
	        <h1 style="color:#fff;">INFORMACIÓN DESTACADA</h1>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="Imagenes_Carrusel\futbol1.jpg" alt="Chania">
			...
			<div class="item">
				<img src="Imagenes_Carrusel\futbol4.jpg" alt="Chania">
				<div class="carousel-caption">
			...
			<div class="item">
				<img src="Imagenes_Carrusel\futbol6.jpg" alt="Chania">
				<div class="carousel-caption">
			...
			<div class="item">
				<img src="Imagenes_Carrusel\futbol3.jpg" alt="Chania">
				<div class="carousel-caption">
	...
	<div class="container_noticias">
		<div class="row">
		    <div class="col-sm-6">
		    	<img src="Imagenes_Home/canchita1.jpg" width="550" height="400" class="img-rounded" alt="Cinque Terre">
		    	<h3 class="texto-blanco">Campeonato pepito</h3>
		    	<P class="texto-blanco">12 equipos participaron por la copa peptio</P>
		    </div>
		    <div class="col-sm-6">
		    	<img src="Imagenes_Home/canchita2.jpg" width="550" height="400" class="img-rounded" alt="Cinque Terre">
